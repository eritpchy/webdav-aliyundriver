...
> 2024.07.18 阿里云盘正式推出了**三方权益包**! 至此, 非权益包用户, 非SVIP会员用户, 没有高速流量! 均被阿里云盘下载限速500kb/s单节点, 每个用户限制3个连接, 超出返回403, **已知, 目前版本nPlayer、Kodi均受3个连接影响导致不能播放、播放中断、403错误等, 目前需等候阿里云盘官方解决.** 另外有SVIP的用户可以先用阿里TV调用第三方播放器,比如Kodi(不确定是否是原画), 实现曲线救国.
